 ...
 */
@Entity
@Table(name = "schema_version", catalog = "store_manager")
public class SchemaVersion implements java.io.Serializable {
	...
	public SchemaVersion(String version, int versionRank, int installedRank, String description, String type,
			String script, String installedBy, Date installedOn, int executionTime, boolean success) {
	...
	public SchemaVersion(String version, int versionRank, int installedRank, String description, String type,
			String script, Integer checksum, String installedBy, Date installedOn, int executionTime, boolean success) {
		this.version = version;
		this.versionRank = versionRank;
		this.installedRank = installedRank;
		this.description = description;
